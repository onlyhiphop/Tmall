...
public class Item_param implements Serializable {
    private Long id;
    ...
    public Item_param(Long id, Long itemCatId, Date created, Date updated, String paramData) {
        this.id = id;
    ...
    public boolean equals(Object that) {
        ...
        Item_param other = (Item_param) that;
